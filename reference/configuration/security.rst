...
.. versionadded:: 4.3
    ...
    The ``sodium`` password encoder was introduced in Symfony 4.3. In previous
    Symfony versions it was called ``argon2i``.
...
.. versionadded:: 4.3
    ...
    The Sodium password encoder was introduced in Symfony 4.3. In previous
    Symfony versions it was called Argon2i password encoder.

It uses the `Argon2 key derivation function`_ and it's the encoder recommended
by Symfony. Sodium support was introduced in PHP 7.2, but if you use an earlier
